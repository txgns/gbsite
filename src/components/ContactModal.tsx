  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-robotics-black-lighter border-robotics-black-light text-white max-w-lg">
        <DialogHeader>
          <DialogTitle className="text-xl sm:text-2xl font-bold text-gradient">Junte-se à Gambiarra Robotics</DialogTitle>
          <DialogDescription className="text-white/70">
            Interessado em participar da nossa equipe de robótica? Preencha o formulário abaixo e entraremos em contato.
          </DialogDescription>
        </DialogHeader>
